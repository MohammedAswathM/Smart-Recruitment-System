...
class RankedResume(models.Model):
    name = models.CharField(max_length=255)  # Resume name
    summary = models.TextField()  # Resume summary
    score = models.FloatField()  # Final ranking score
    job_title = models.CharField(max_length=255)  # Associated job title
    timestamp = models.DateTimeField(auto_now_add=True)  # Timestamp of when the ranking was done
